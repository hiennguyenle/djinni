...
struct DjinniCgoListInt16T
{
    static cgo__list__int16_t from_cpp(const std::vector<int16_t> & data);
    static std::vector<int16_t> to_cpp(const cgo__list__int16_t & data);
};
